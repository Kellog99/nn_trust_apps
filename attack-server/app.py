...
def parse_arguments():
    ...
    parser.add_argument(
        '--max_model_size_upload',
        type=int,
        default=5000,
        help='Maximum model file size for upload in MB'
    )
    parser.add_argument(
        '--max_model_json_size_upload',
        type=int,
        default=5000,
        help='Maximum model JSON file size for upload in MB'
    )
    parser.add_argument(
        '--ray_address',
        type=str,
        default=None,
        help='Ray cluster address (e.g., 127.0.0.1:6379). If None, initializes local cluster'
    )
    parser.add_argument(
        '--ray_py_modules',
        type=str,
        default=None,
        help='Path to Python modules to include in Ray runtime environment'
    )
