...
from lib.model import ExecutionConfig, ReportProps, Error
...
benchmarking = "ss"  # importlib.import_module("benchmarking")
...
def get_reports() -> list[ReportProps]:
    """
        ...
        """
    reports = []
    for dirpath, dirnames, filenames in os.walk(os.environ.walkn.get("BENCHMARK_OUTPUT_DIR")):
