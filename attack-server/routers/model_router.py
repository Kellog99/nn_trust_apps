...
async def upload_model_check(file: UploadFile) -> JSONResponse:
    """
...
async def upload_model_proceed(model_name: str = Query(..., description="The name of the model (stem of the original ZIP file)")) -> Response:
    """
